...
class AMprefsController: NSWindowController {
    ...
    var initialSettings = [String: Any]()
    ...
    func setAllArrayVals() {
        pairWeightsCont.vals = settings.array(forKey:globals.pairScores)! as! [[Int]]
        matchWeightsCont.vals = settings.array(forKey:globals.matchWeights)! as! [Int]
        runWeightsCont.vals = settings.array(forKey:globals.runWeights)! as! [Int]
        entropyCont.vals = settings.array(forKey:globals.entropy)! as! [[Int]]
        enthalpyCont.vals = settings.array(forKey:globals.enthalpy)! as! [[Int]]
        dimWeightsCont.vals = settings.array(forKey:globals.dimScores)! as! [[Int]]
    }
