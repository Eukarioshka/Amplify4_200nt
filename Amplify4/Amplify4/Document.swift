...
//    var mapView = MapView()
    ...
    let runWeights = UserDefaults.standard.array(forKey:globals.runWeights)! as! [Int]
    let pairScores = UserDefaults.standard.array(forKey:globals.pairScores)! as! [[Int]]
    let maxLength = UserDefaults.standard.integerForKey(globals.effectivePrimer)
    var opn = 100
...
//        self.printInfo.verticalPagination = NSPrintingPaginationMode.FitPagination
    ...
    override func windowControllerDidLoadNib(aController: NSWindowController) {
        ...
        NotificationCenter.defaultCenter().addObserver(self, selector: "boundsDidChange:", name:  NSViewFrameDidChangeNotification, object: mapClipView)
...
//    }
    ...
    @IBAction func roundButton(sender: AnyObject) {
        ...
        var mapURL = savePanel.URL! as URL
    ...
    override func saveDocumentAs(sender: AnyObject?) {
        ...
        if savePanel.runModal() == NSCancelButton {return}
        if let saveURL: URL = savePanel.URL {
            ...
            case 1: // save text output as rtf
                let rtfURL: URL = saveURL.URLByDeletingPathExtension!.URLByAppendingPathExtension("rtf")
